...
if st.button('example monte carlo'):
    response = """
{"expectedAnnualReturnTable": {"percentiles": {"10thPercentile": {"1Year": "-2.49%", "3Years": "1.75%", "5Years": "3.14%", "10Years": "4.69%", "15Years": "5.34%", "20Years": "5.77%", "25Years": "6.07%", "30Years": "6.28%"}, "25thPercentile": {"1Year": "2.19%", "3Years": "5.04%", "5Years": "5.75%", "10Years": "6.50%", "15Years": "6.86%", "20Years": "7.05%", "25Years": "7.20%", "30Years": "7.31%"}, "50thPercentile": {"1Year": "8.38%", "3Years": "8.45%", "5Years": "8.48%", "10Years": "8.48%", "15Years": "8.46%", "20Years": "8.47%", "25Years": "8.49%", "30Years": "8.50%"}, "75thPercentile": {"1Year": "12.54%", "3Years": "12.14%", "5Years": "11.38%", "10Years": "10.54%", "15Years": "10.15%", "20Years": "9.89%", "25Years": "9.75%", "30Years": "9.64%"}, "90thPercentile": {"1Year": "19.76%", "3Years": "15.63%", "5Years": "14.05%", "10Years": "12.41%", "15Years": "11.65%", "20Years": "11.18%", "25Years": "10.92%", "30Years": "10.69%"}}}}
    """

    json_response = json.loads(response)

    df = pd.DataFrame(json_response['expectedAnnualReturnTable']['percentiles'])
